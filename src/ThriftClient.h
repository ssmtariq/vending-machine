#ifndef VENDING_MACHINE_MICROSERVICES_THRIFTCLIENT_H
#define VENDING_MACHINE_MICROSERVICES_THRIFTCLIENT_H
...
#endif //VENDING_MACHINE_MICROSERVICES_THRIFTCLIENT_H
